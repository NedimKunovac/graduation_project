                  ...
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        height: 70.0,
                        width: 70.0,
                        child: Image.network(widget.data['profilePhotoUrl']),
                      ),
                    ),
                  ),
                      ...
                      Stack(
                        children: [
                          Row(
                            ...
                            children: [
                              RenderTags(
                                addedChips: List<String>.from(widget.data['requirements'] as List),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: Text(
                                  '+1',///Number regarding other skills that are required but arent displayed on the dashboard card. Currently this is UI element only
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 10,
                                  ),
