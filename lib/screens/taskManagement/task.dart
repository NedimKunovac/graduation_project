...
class Task{
  ...
  bool? isLast;
  Task({this.iconData, this.title,this.bgColor,this.iconColor,this.left,this.done,this.desc,this.btnColor,this.isLast = false});
  static List<Task> generatedTasks(){///Generated tasks can be replaced with our backend
    return[
